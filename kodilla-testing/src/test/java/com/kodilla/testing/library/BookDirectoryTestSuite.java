...
class BookDirectoryTestSuite {
    ...
    void testlistBooksInHandsOf() {
        // Given
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser user1 = new LibraryUser("Tomasz", "Labutka", "73121909754" );
        LibraryUser user2 = new LibraryUser("Zenek", "Kowal", "78122005743" );
        LibraryUser user3 = new LibraryUser("Jan", "Janecki", "80101109651" );
