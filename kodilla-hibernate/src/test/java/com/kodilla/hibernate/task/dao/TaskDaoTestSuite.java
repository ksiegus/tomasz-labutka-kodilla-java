...
class TaskDaoTestSuite {
    ...
    void testNamedQueries() {
        ...
        TaskListToDo taskList = new TaskListToDo("ToDo", "ToDo tasks");
        taskList.getTasks().add(task1);
        taskList.getTasks().add(task2);
        taskList.getTasks().add(task3);
        taskList.getTasks().add(task4);

        task1.setTaskListToDo(taskList);
        task2.setTaskListToDo(taskList);
        task3.setTaskListToDo(taskList);
        task4.setTaskListToDo(taskList);

        taskListToDoDao.save(taskList);
